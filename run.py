# Importing gspread API and credentials to be able to open
# and read from the google sheet
import gspread
...
def  get_average_age():
    ...
    # This code gets the sum of the ages list and puts them
    #  into the total_age variable, then calculates the average age.
...
def  get_perc_male():
    ...
    # Checks the see if the values in the list are M(male), if there are
    # it adds them to the males list
...
def get_perc_female():
    ...
    adds to a list, then calculates the percentage
    """
